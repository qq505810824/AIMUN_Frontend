const translation = {
    ...
    backupEmail: {
        ...
        description:
            'Setting a recovery email helps you recover your account if you forget your password',
        emailAddress: 'Recovery Email Address',
        enterEmail: 'Please enter your recovery email address',
        confirmationSent:
            'A confirmation email has been sent to {email}. Please check your inbox and click the confirmation link',
        resendConfirmation: 'Resend Confirmation Email',
        resendSuccess: 'A new confirmation email has been successfully sent',
        confirmationSuccess: 'Your recovery email has been successfully confirmed!',
        confirmationFailed: 'Recovery Email Confirmation Failed',
        redirecting: 'Redirecting to homepage...',
        notSet: 'You have not set a recovery email yet',
        add: 'Add Recovery Email',
        change: 'Change',
        remove: 'Remove',
        confirmed: 'Confirmed',
        pending: 'Pending',
        updateSuccess: 'Recovery email has been updated',
        removeSuccess: 'Recovery email has been removed',
        confirmRemove: 'Are you sure you want to remove your recovery email?',
        errors: {
            emailRequired: 'Please enter an email address',
            tokenInvalid: 'Invalid confirmation link',
            tokenExpired: 'The confirmation link has expired, please request a new one',
            tokenUsed: 'This confirmation link has already been used',
            confirmationFailed:
                'Recovery email confirmation failed, please try again later or contact support'
        }
    }
};
