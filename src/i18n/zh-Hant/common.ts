const translation = {
    ...
    backupEmail: {
        title: '設置後備電子郵件',
        description: '設置後備電子郵件可以幫助您在忘記密碼時恢復您的帳戶',
        emailAddress: '後備電子郵件地址',
        enterEmail: '請輸入您的後備電子郵件地址',
        confirmationSent: '確認郵件已發送至 {email}，請檢查您的收件箱並點擊確認鏈接',
        resendConfirmation: '重新發送確認郵件',
        resendSuccess: '新的確認郵件已成功發送',
        confirmationSuccess: '您的後備電子郵件已成功確認！',
        confirmationFailed: '後備電子郵件確認失敗',
        redirecting: '正在重定向到首頁...',
        notSet: '您尚未設置後備電子郵件',
        add: '添加後備電子郵件',
        change: '更改',
        remove: '移除',
        confirmed: '已確認',
        pending: '待確認',
        updateSuccess: '後備電子郵件已更新',
        removeSuccess: '後備電子郵件已移除',
        confirmRemove: '確定要移除後備電子郵件嗎？',
        errors: {
            emailRequired: '請輸入電子郵件地址',
            tokenInvalid: '無效的確認鏈接',
            tokenExpired: '確認鏈接已過期，請重新發送確認郵件',
            tokenUsed: '此確認鏈接已被使用過',
            confirmationFailed: '後備電子郵件確認失敗，請稍後重試或聯繫支持'
        }
    }
};
