        ...
        <>
            <main className="route-container pt-16 pb-24">
                ...
                <p className="mt-3 text-gray-700 max-w-3xl">
                    AI English blends state-of-the-art language models, speech analysis, and assessment design into
                    a secure, school-ready platform—delivering reliable, explainable feedback in seconds.
                </p>
                ...
                <div className="mt-10 grid md:grid-cols-3 gap-6">
                    ...
                    <div className="card">
                        ...
                        <div className="text-gray-600 text-sm mt-1">
                            Evaluates fluency, coherence, and pronunciation with configurable thresholds.
                        </div>
                    </div>
                    <div className="card">
                        ...
                        <div className="text-gray-600 text-sm mt-1">
                            Manual score release, join codes, and XLSX export provide oversight without friction.
                        </div>
                    </div>
                </div>
